...
PRIMARY KEY (Hotel_name,Hotel_Location,Room_number))
ENGINE=InnoDB DEFAULT CHARSET=latin1;
-- FOREIGN KEY (Hotel_Location) REFERENCES ROOM(Hotel_Location))
/*!40101 SET character_set_client = @saved_cs_client */;
...
PRIMARY KEY (Hotel_name,Hotel_Location)
-- FOREIGN KEY (Hotel_Location) REFERENCES HOTEL(Hotel_Location)
)
ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES    
('h1f1',    'h1l1', 1,'h1', 'h1loc',    11976453,'h1r1',      1, 'MANAGER        '),
('h1f2',    'h1l2', 2,'h1', 'h1loc',    12976453,'h1r2',      1, 'RECEPTIONIST   '),
('h1f3',    'h1l3', 3,'h1', 'h1loc',    13976453,'h1r3',      1, 'ACCOUNTANT      '),
('h1f4',    'h1l4', 4,'h1', 'h1loc',    14976453,'h1r4',      1, 'HOUSE_KEEPER    '),
('h1f5',    'h1l5', 5,'h1', 'h1loc',    15976453,'h1r5',      1, 'HOUSE_KEEPER    '),


('h2f1',    'h2l1', 1,'h2', 'h2loc',    21976454,'h2r1',      1, 'MANAGER        '),
('h2f2',    'h2l2', 2,'h2', 'h2loc',    22976454,'h2r2',      1, 'ACCOUNTANT      '),
('h2f3',    'h2l3', 3,'h2', 'h2loc',    23976454,'h2r3',      1, 'RECEPTIONIST   '),
('h2f4',    'h2l4', 4,'h2', 'h2loc',    24976454,'h2r4',      1, 'HOUSE_KEEPER    '),
('h2f5',    'h2l5', 5,'h2', 'h2loc',    25976454,'h2r5',      1, 'SECURITY_GAURD  '),



('h3f1',    'h3l1', 1,'h3', 'h3loc',    31976455,'h3r1',      1, 'MANAGER        '),
('h3f2',    'h3l2', 2,'h3', 'h3loc',    32976455,'h3r2',      1, 'ACCOUNTANT      '),
('h3f3',    'h3l3', 3,'h3', 'h3loc',    33976455,'h3r3',      1, 'RECEPTIONIST   '),
('h3f4',    'h3l4', 4,'h3', 'h3loc',    34976455,'h3r4',      1, 'SECURITY_GAURD  '),
('h3f5',    'h3l5', 5,'h3', 'h3loc',    35976455,'h3r5',      1, 'HOUSE_KEEPER    '),



('h4f1',    'h4l1', 1,'h4', 'h4loc',    41976456,'h4r1',      1, 'MANAGER        '),
('h4f2',    'h4l2', 2,'h4', 'h4loc',    42976456,'h4r2',      1, 'ACCOUNTANT      '),
('h4f3',    'h4l3', 3,'h4', 'h4loc',    43976456,'h4r3',      1, 'SECURITY_GAURD  '),
('h4f4',    'h4l4', 4,'h4', 'h4loc',    44976456,'h4r4',      1, 'RECEPTIONIST   '),
('h4f5',    'h4l5', 5,'h4', 'h4loc',    45976456,'h4r5',      1, 'SECURITY_GAURD  '),



('h5f1',    'h5l1', 1,'h5', 'h5loc',    51976457,'h5r1',      1, 'MANAGER        '),
('h5f2',    'h5l2', 2,'h5', 'h5loc',    52976457,'h5r2',      1, 'RECEPTIONIST   '),
('h5f3',    'h5l3', 3,'h5', 'h5loc',    53976457,'h5r3',      1, 'ACCOUNTANT      '),
('h5f4',    'h5l4', 4,'h5', 'h5loc',    54976457,'h5r4',      1, 'HOUSE_KEEPER    '),
('h5f5',    'h5l5', 5,'h5', 'h5loc',    55976457,'h5r5',      1, 'SECURITY_GAURD  ');
...
('c12cit',   'c12st', 'c12cou',    'c12emid',   'M',  9121234567, '1981-09-19',    'c12f',  'c12l',    45),
...
-- hotel's with highest average rating are most visited --
-- hotel's with sofa-set and parking area are most preferred ----
